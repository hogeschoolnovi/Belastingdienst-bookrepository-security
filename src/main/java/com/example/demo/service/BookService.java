...
public class BookService {
    ...
    public void updateBook(BookDto bookDto, Long id){
        ...
        if(bookOptional.isPresent()){
            ...
            if(bookDto.getAuthor() != null){
                book.setAuthor(AuthorService.toAuthor(bookDto.getAuthor()));
            }
    ...
    private BookDto fromBook(Book book){
        ...
        if(book.getAuthor() != null) {
            dto.setAuthor(AuthorService.fromAuthor(book.getAuthor()));
        }
        dto.setPublished(book.getPublished());
        if(book.getCover() != null) {
            dto.setCover(CoverService.fromCover(book.getCover()));
        }
        return dto;
    }
    ...
    private Book toBook(BookDto dto){
        ...
        book.setAuthor(AuthorService.toAuthor(dto.getAuthor()));
        book.setPublished(dto.getPublished());
        book.setCover(CoverService.toCover(dto.getCover()));
        return book;
    }
}
